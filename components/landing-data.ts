...
export const packages = [
  {
    name: "Basic",
    price: "Rp49.000",
    note: "Undangan simpel, elegan, dan cepat jadi.",
  ...
  },
  {
    name: "Exclusive",
    price: "Rp149.000",
    note: "Tampilan undangan lebih elegan dan eksklusif.",
    cta: "Ambil Exclusive 149rb",
    benefits: [
      "Semua fitur Premium",
...
export const addOns = [
  {
    ...
    title: "Domain .my.id",
    price: "+Rp29.000",
    text: "Gunakan domain .my.id untuk link undangan.",
  },
  {
    icon: Zap,
    title: "Express pengerjaan",
    price: "+Rp49.000",
  ...
  },
  {
    ...
    price: "+Rp25.000",
    text: "Perpanjang masa aktif link undangan.",
  },
  {
    icon: Palette,
    title: "Custom design",
